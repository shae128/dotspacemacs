...
you should place your code here."
  ...
  ;; YAPF mode for python code style
  (add-hook 'python-mode-hook 'yapf-mode)

  ;; configure flycheck python checkers
